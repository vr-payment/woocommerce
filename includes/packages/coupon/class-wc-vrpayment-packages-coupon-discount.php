...
class WC_VRPayment_Packages_Coupon_Discount {
	...
	public static function init() {
		...
		add_filter(
			'wc_vrpayment_packages_coupon_discount_totals_including_tax',
			array(
				__CLASS__,
		...
		add_filter(
			'wc_vrpayment_packages_coupon_has_coupon_discounts_applied',
			array(
				__CLASS__,
	...
	public static function has_coupon_discounts_applied( $currency ) {
		$discount = apply_filters( 'wc_vrpayment_packages_coupon_discount_totals_including_tax', $currency ); //phpcs:ignore
		return $discount > 0;
	}
