...
/**
 * This service provides functions to deal with VRPay transactions.
 */
class WC_VRPayment_Service_Transaction extends WC_VRPayment_Service_Abstract {
	...
	protected function get_transaction_service() {
		if ( is_null( $this->transaction_service ) ) {
			$this->transaction_service = new \VRPayment\Sdk\Service\TransactionService( WC_VRPayment_Helper::instance()->get_api_client() );
		}
	...
	protected function get_transaction_iframe_service() {
		if ( is_null( $this->transaction_iframe_service ) ) {
			$this->transaction_iframe_service = new \VRPayment\Sdk\Service\TransactionIframeService( WC_VRPayment_Helper::instance()->get_api_client() );
		}
	...
	protected function get_transaction_lightbox_service() {
		if ( is_null( $this->transaction_lightbox_service ) ) {
			$this->transaction_lightbox_service = new \VRPayment\Sdk\Service\TransactionLightboxService( WC_VRPayment_Helper::instance()->get_api_client() );
		}
	...
	protected function get_transaction_payment_page_service() {
		if ( is_null( $this->transaction_payment_page_service ) ) {
			$this->transaction_payment_page_service = new \VRPayment\Sdk\Service\TransactionPaymentPageService( WC_VRPayment_Helper::instance()->get_api_client() );
		}
	...
	protected function get_charge_attempt_service() {
		if ( is_null( $this->charge_attempt_service ) ) {
			$this->charge_attempt_service = new \VRPayment\Sdk\Service\ChargeAttemptService( WC_VRPayment_Helper::instance()->get_api_client() );
		}
	...
	protected function get_transaction_line_item_version_service() {
		if ( is_null( $this->transaction_line_item_version_service ) ) {
			$this->transaction_line_item_version_service = new \VRPayment\Sdk\Service\TransactionLineItemVersionService( WC_VRPayment_Helper::instance()->get_api_client() );
		}
	...
	/**
	 * Returns the URL to VRPay's JavaScript library that is necessary to display the payment form.
	 *
	 ...
	 */
	protected function assemble_order_transaction_data( WC_Order $order, \VRPayment\Sdk\Model\AbstractTransactionPending $transaction ) {
