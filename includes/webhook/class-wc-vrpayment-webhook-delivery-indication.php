...
class WC_VRPayment_Webhook_Delivery_Indication extends WC_VRPayment_Webhook_Order_Related_Abstract {
	 ...
	 * Canonical processor.
	 *
	 * @var WC_VRPayment_Webhook_Delivery_Indication_Strategy
	 */
	private $strategy;
	...
	public function __construct() {
		$this->strategy = new WC_VRPayment_Webhook_Delivery_Indication_Strategy();
	}
	...
	protected function load_entity( WC_VRPayment_Webhook_Request $request ) {
		wc_deprecated_function(
            __METHOD__,
            '3.0.12',
            'WC_VRPayment_Webhook_Delivery_Indication_Strategy::load_entity'
        );
	...
	protected function get_order_id( $delivery_indication ) {
		wc_deprecated_function(
            __METHOD__,
            '3.0.12',
            'WC_VRPayment_Webhook_Delivery_Indication_Strategy::get_order_id'
        );
	...
	protected function process_order_related_inner( WC_Order $order, $delivery_indication, $request ) {
		wc_deprecated_function(
            __METHOD__,
            '3.0.12',
            'WC_VRPayment_Webhook_Delivery_Indication_Strategy::process_order_related_inner'
        );
