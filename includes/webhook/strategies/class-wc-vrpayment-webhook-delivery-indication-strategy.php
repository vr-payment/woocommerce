...
class WC_VRPayment_Webhook_Delivery_Indication_Strategy extends WC_VRPayment_Webhook_Strategy_Base {
	...
	protected function load_entity( WC_VRPayment_Webhook_Request $request ) {
		$transaction_invoice_service = new \VRPayment\Sdk\Service\DeliveryIndicationService( WC_VRPayment_Helper::instance()->get_api_client() );
	 ...
	 * @return void
	 */
	protected function process_order_related_inner( WC_Order $order, \VRPayment\Sdk\Model\DeliveryIndication $delivery_indication, WC_VRPayment_Webhook_Request $request ) {
