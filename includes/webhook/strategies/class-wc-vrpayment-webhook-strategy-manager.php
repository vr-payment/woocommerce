 ...
 */
class WC_VRPayment_Webhook_Strategy_Manager {
	 ...
	 *
	 * @var WC_VRPayment_Service_Webhook
	 */
	 ...
	 *
	 * @var WC_VRPayment_Webhook_Strategy_Manager
	 */
	...
	public function __construct() {
		$this->webhook_service = WC_VRPayment_Service_Webhook::instance();
		$this->helper = WC_VRPayment_Helper::instance();
	...
	private function configure_strategies_to_handle_webhooks() {
		$this->strategies[] = new WC_VRPayment_Webhook_Manual_Task_Strategy();
		$this->strategies[] = new WC_VRPayment_Webhook_Method_Configuration_Strategy();
		$this->strategies[] = new WC_VRPayment_Webhook_Transaction_Strategy();
		$this->strategies[] = new WC_VRPayment_Webhook_Delivery_Indication_Strategy();
		$this->strategies[] = new WC_VRPayment_Webhook_Transaction_Invoice_Strategy();
		$this->strategies[] = new WC_VRPayment_Webhook_Transaction_Completion_Strategy();
		$this->strategies[] = new WC_VRPayment_Webhook_Transaction_Void_Strategy();
		$this->strategies[] = new WC_VRPayment_Webhook_Refund_Strategy();
		$this->strategies[] = new WC_VRPayment_Webhook_Token_Strategy();
		$this->strategies[] = new WC_VRPayment_Webhook_Token_Version_Strategy();
	}
	 ...
	 *
	 * @param WC_VRPayment_Webhook_Request $request The incoming webhook request.
	 * @return WC_VRPayment_Webhook_Strategy_Interface The strategy to handle the request.
	 * @throws Exception If no strategy can be resolved.
	 */
	private function resolve_strategy( WC_VRPayment_Webhook_Request $request ) {
	 ...
	 * throws an exception.
	 *
	 * @param WC_VRPayment_Webhook_Request $request The incoming webhook request object.
