...
class WC_VRPayment_Webhook_Transaction_Invoice_Strategy extends WC_VRPayment_Webhook_Strategy_Base {
	 ...
	 * @return void
	 */
	public function bridge_process_order_related_inner( WC_Order $order, \VRPayment\Sdk\Model\TransactionInvoice $transaction_invoice, WC_VRPayment_Webhook_Request $request ) {
	 ...
	 * @return void
	 */
	protected function process_order_related_inner( WC_Order $order, \VRPayment\Sdk\Model\TransactionInvoice $transaction_invoice, WC_VRPayment_Webhook_Request $request, $legacy_mode = false ) {
