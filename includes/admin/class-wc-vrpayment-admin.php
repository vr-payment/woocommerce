...
class WC_VRPayment_Admin {
	...
	public function display_attribute_options_edit() {
		...
		echo esc_html(
			...
			) . esc_html__( 'Send attribute to VRPay.', 'woo-vrpayment' ) . esc_html(
						'</label>
					</th>
						<td>
							...
							'/>
							<p class="description">'
			) . esc_html__( 'Should this product attribute be sent to VRPay as line item attribute?', 'woo-vrpayment' ) . esc_html(
							'</p>
						</td>
				</tr>'
			);
	...
	public function display_attribute_options_add() {
		echo esc_html(
			'<div class="form-field">
				...
				'</label>
				<p class="description">'
		) . esc_html__( 'Should this product attribute be sent to VRPay as line item attribute?', 'woo-vrpayment' ) .
		esc_html(
				'</p>
			</div>'
		);
