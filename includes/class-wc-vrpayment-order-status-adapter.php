...
class WC_VRPayment_Order_Status_Adapter
{
	...
	public function store_default_status_mappings_on_database(): void
	{
		...
		foreach ( $default_mappings as $key => $value ) {
			if ( get_option( self::VRPAYMENT_ORDER_STATUS_MAPPING_PREFIX . $key, false ) === false ) {
				update_option( self::VRPAYMENT_ORDER_STATUS_MAPPING_PREFIX . $key, $value );
			}
		}
	}
	 ...
	 * - vrpayment_order_status_mapping_fulfill -> wc-completed -> OrderInternalStatus::COMPLETED
	 *
