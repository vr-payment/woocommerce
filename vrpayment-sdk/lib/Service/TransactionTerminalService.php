...
class TransactionTerminalService {
	 ...
	 * @param \VRPayment\Sdk\Model\TerminalReceiptFetchRequest $request  (required)
	 * @throws \VRPayment\Sdk\ApiException
	 * @throws \VRPayment\Sdk\VersioningException
	 * @throws \VRPayment\Sdk\Http\ConnectionException
	 * @return \VRPayment\Sdk\Model\RenderedTerminalReceipt[]
	 */
	...
	public function fetchReceiptsWithHttpInfo($space_id, $request) {
		...
		try {
			$response = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\VRPayment\Sdk\Model\RenderedTerminalReceipt[]',
				'/transaction-terminal/fetch-receipts'
            );
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\VRPayment\Sdk\Model\RenderedTerminalReceipt[]', $response->getHeaders()));
