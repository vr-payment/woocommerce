...
use VRPayment\Sdk\EncryptionUtil;
...
class WebhookEncryptionService {
	 ...
	 * @return \VRPayment\Sdk\Model\WebhookEncryptionPublicKey
	 */
	...
	public function readWithHttpInfo($id) {
		...
		try {
			$response = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\VRPayment\Sdk\Model\WebhookEncryptionPublicKey',
				'/webhook-encryption/read'
            );
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\VRPayment\Sdk\Model\WebhookEncryptionPublicKey', $response->getHeaders()));
