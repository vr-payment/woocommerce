...
class WebAppService {
	 ...
	 * Confirm
	 *
	 * @param \VRPayment\Sdk\Model\WebAppConfirmationRequest $request  (required)
	 * @throws \VRPayment\Sdk\ApiException
	 * @throws \VRPayment\Sdk\VersioningException
	 * @throws \VRPayment\Sdk\Http\ConnectionException
	 * @return \VRPayment\Sdk\Model\WebAppConfirmationResponse
	 */
	...
	public function confirmWithHttpInfo($request) {
		...
		try {
			$response = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\VRPayment\Sdk\Model\WebAppConfirmationResponse',
				'/web-app/confirm'
            );
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\VRPayment\Sdk\Model\WebAppConfirmationResponse', $response->getHeaders()));
		} catch (ApiException $e) {
			switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
