...
class CardProcessingService {
	 ...
	 * @param \VRPayment\Sdk\Model\AuthenticatedCardDataCreate $card_data The card details as JSON in plain which should be used to authorize the payment. (required)
	 ...
	 * @param int $transaction_id The ID of the transaction which should be processed. (required)
	 * @param int $payment_method_configuration_id The payment method configuration ID which is applied to the transaction. (required)
	 * @param \VRPayment\Sdk\Model\TokenizedCardDataCreate $card_data The card details as JSON in plain which should be used to authorize the payment. (required)
	 * @throws \VRPayment\Sdk\ApiException
	 * @throws \VRPayment\Sdk\VersioningException
	 * @throws \VRPayment\Sdk\Http\ConnectionException
	 * @return string
