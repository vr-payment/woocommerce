...
class ConditionTypeService {
	 ...
	 * @return \VRPayment\Sdk\Model\ConditionType[]
	 */
	public function all() {
	...
	public function allWithHttpInfo() {
		...
		try {
			$response = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\VRPayment\Sdk\Model\ConditionType[]',
				'/condition-type/all'
            );
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\VRPayment\Sdk\Model\ConditionType[]', $response->getHeaders()));
