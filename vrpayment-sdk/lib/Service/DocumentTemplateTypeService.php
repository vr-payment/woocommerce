...
class DocumentTemplateTypeService {
	 ...
	 * @return \VRPayment\Sdk\Model\DocumentTemplateType[]
	 */
	public function all() {
	...
	public function allWithHttpInfo() {
		...
		try {
			$response = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\VRPayment\Sdk\Model\DocumentTemplateType[]',
				'/document-template-type/all'
            );
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\VRPayment\Sdk\Model\DocumentTemplateType[]', $response->getHeaders()));
