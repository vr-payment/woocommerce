...
class TerminalReceiptFetchRequest implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'format' => '\VRPayment\Sdk\Model\TerminalReceiptFormat',
        'transaction' => 'int',
        'width' => 'int'
    ];
     ...
     * Gets format
     *
     * @return \VRPayment\Sdk\Model\TerminalReceiptFormat
     */
     ...
     * Sets format
     *
     * @param \VRPayment\Sdk\Model\TerminalReceiptFormat $format The format determines in what format the receipts will be returned in.
     *
     * @return $this
     */
