...
class InvoiceReconciliationRecord extends TransactionAwareEntity 
{
    ...
    protected static $swaggerTypes = [
        ...
        'given_name' => 'string',
        'iban' => 'string',
        'last_resolution_failure' => '\VRPayment\Sdk\Model\FailureReason',
        ...
        'rejection_status' => '\VRPayment\Sdk\Model\InvoiceReconciliationRecordRejectionStatus',
        'resolved_by' => 'int',
        'resolved_on' => '\DateTime',
        'sender_bank_account' => 'string',
        'state' => '\VRPayment\Sdk\Model\InvoiceReconciliationRecordState',
        'street' => 'string',
        'type' => '\VRPayment\Sdk\Model\InvoiceReconciliationRecordType',
        'unique_id' => 'string',
        'value_date' => '\DateTime',
        'version' => 'int'
    ];
     ...
     *
     * @param \VRPayment\Sdk\Model\FailureReason $last_resolution_failure 
     *
     * @return $this
     */
     ...
     *
     * @return \VRPayment\Sdk\Model\InvoiceReconciliationRecordRejectionStatus
     */
     ...
     *
     * @param \VRPayment\Sdk\Model\InvoiceReconciliationRecordRejectionStatus $rejection_status 
     *
     * @return $this
     */
     ...
     * Gets state
     *
     * @return \VRPayment\Sdk\Model\InvoiceReconciliationRecordState
     */
     ...
     * Sets state
     *
     * @param \VRPayment\Sdk\Model\InvoiceReconciliationRecordState $state The object's current state.
     *
     * @return $this
     */
     ...
     * Gets type
     *
     * @return \VRPayment\Sdk\Model\InvoiceReconciliationRecordType
     */
     ...
     * Sets type
     *
     * @param \VRPayment\Sdk\Model\InvoiceReconciliationRecordType $type 
     *
     * @return $this
     */
