...
class PaymentAppChargeAttemptUpdateRequest implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'reference' => 'string',
        'target_state' => '\VRPayment\Sdk\Model\PaymentAppChargeAttemptTargetState'
    ];
     ...
     * Gets target_state
     *
     * @return \VRPayment\Sdk\Model\PaymentAppChargeAttemptTargetState
     */
     ...
     * Sets target_state
     *
     * @param \VRPayment\Sdk\Model\PaymentAppChargeAttemptTargetState $target_state The target state defines the state into which the charge attempt should be switched into. Once the charge attempt changed the state it will not be possible to change it again.
     *
     * @return $this
     */
