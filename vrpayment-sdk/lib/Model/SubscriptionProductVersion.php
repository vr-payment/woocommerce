...
class SubscriptionProductVersion implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'product' => '\VRPayment\Sdk\Model\SubscriptionProduct',
        'reference' => 'string',
        'retiring_finished_on' => '\DateTime',
        'retiring_started_on' => '\DateTime',
        'state' => '\VRPayment\Sdk\Model\SubscriptionProductVersionState',
        'tax_calculation' => '\VRPayment\Sdk\Model\TaxCalculation',
        'version' => 'int'
    ];
     ...
     * Gets product
     *
     * @return \VRPayment\Sdk\Model\SubscriptionProduct
     */
     ...
     * Sets product
     *
     * @param \VRPayment\Sdk\Model\SubscriptionProduct $product The product that the version belongs to.
     *
     * @return $this
     */
     ...
     * Gets state
     *
     * @return \VRPayment\Sdk\Model\SubscriptionProductVersionState
     */
     ...
     * Sets state
     *
     * @param \VRPayment\Sdk\Model\SubscriptionProductVersionState $state The object's current state.
     *
     * @return $this
     */
     ...
     *
     * @return \VRPayment\Sdk\Model\TaxCalculation
     */
     ...
     *
     * @param \VRPayment\Sdk\Model\TaxCalculation $tax_calculation The way taxes are calculated for fees.
     *
     * @return $this
     */
