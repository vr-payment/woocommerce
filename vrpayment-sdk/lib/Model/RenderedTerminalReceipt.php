...
class RenderedTerminalReceipt implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'mime_type' => 'string',
        'printed' => 'bool',
        'receipt_type' => '\VRPayment\Sdk\Model\PaymentTerminalReceiptType'
    ];
     ...
     * Gets receipt_type
     *
     * @return \VRPayment\Sdk\Model\PaymentTerminalReceiptType
     */
     ...
     * Sets receipt_type
     *
     * @param \VRPayment\Sdk\Model\PaymentTerminalReceiptType $receipt_type Each receipt has a different usage. The receipt type indicates for what resp. for whom the document is for.
     *
     * @return $this
     */
