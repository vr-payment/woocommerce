...
class DeliveryIndication implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'automatic_decision_reason' => '\VRPayment\Sdk\Model\DeliveryIndicationDecisionReason',
        ...
        'state' => '\VRPayment\Sdk\Model\DeliveryIndicationState',
        'timeout_on' => '\DateTime',
     ...
     *
     * @return \VRPayment\Sdk\Model\DeliveryIndicationDecisionReason
     */
     ...
     *
     * @param \VRPayment\Sdk\Model\DeliveryIndicationDecisionReason $automatic_decision_reason The reason for the automatic system decision about the delivery indication.
     *
     * @return $this
     */
     ...
     * Gets state
     *
     * @return \VRPayment\Sdk\Model\DeliveryIndicationState
     */
     ...
     * Sets state
     *
     * @param \VRPayment\Sdk\Model\DeliveryIndicationState $state The object's current state.
     *
     * @return $this
     */
     ...
     * Sets transaction
     *
     * @param \VRPayment\Sdk\Model\Transaction $transaction The payment transaction that the delivery indication is linked to.
     *
     * @return $this
     */
