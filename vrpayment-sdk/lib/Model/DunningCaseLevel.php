...
class DunningCaseLevel implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'created_on' => '\DateTime',
        'dunning_case' => '\VRPayment\Sdk\Model\DunningCase',
        ...
        'state' => '\VRPayment\Sdk\Model\DunningCaseLevelState',
     ...
     * Sets dunning_case
     *
     * @param \VRPayment\Sdk\Model\DunningCase $dunning_case 
     *
     * @return $this
     */
     ...
     * Gets state
     *
     * @return \VRPayment\Sdk\Model\DunningCaseLevelState
     */
     ...
     * Sets state
     *
     * @param \VRPayment\Sdk\Model\DunningCaseLevelState $state The object's current state.
     *
     * @return $this
     */
