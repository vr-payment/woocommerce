...
class ProductMeteredTierFee implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'fee' => '\VRPayment\Sdk\Model\PersistableCurrencyAmount[]',
        'id' => 'int',
        'metered_fee' => '\VRPayment\Sdk\Model\ProductMeteredFee',
        'start_range' => 'float',
        'version' => 'int'
    ];
     ...
     * Sets fee
     *
     * @param \VRPayment\Sdk\Model\PersistableCurrencyAmount[] $fee The amount charged to the customer for each consumed unit at the end of a billing cycle.
     *
     * @return $this
     */
     ...
     * Sets metered_fee
     *
     * @param \VRPayment\Sdk\Model\ProductMeteredFee $metered_fee The metered fee that this tier belongs to.
     *
     * @return $this
     */
