...
class SubscriptionProduct implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'sort_order' => 'int',
        'space_id' => 'int',
        'state' => '\VRPayment\Sdk\Model\SubscriptionProductState',
        'version' => 'int'
    ];
     ...
     * Gets state
     *
     * @return \VRPayment\Sdk\Model\SubscriptionProductState
     */
     ...
     * Sets state
     *
     * @param \VRPayment\Sdk\Model\SubscriptionProductState $state The object's current state.
     *
     * @return $this
     */
