...
class SubscriptionCharge implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'id' => 'int',
        'language' => 'string',
        'ledger_entries' => '\VRPayment\Sdk\Model\SubscriptionLedgerEntry[]',
        'linked_space_id' => 'int',
        'planned_execution_date' => '\DateTime',
        'planned_purge_date' => '\DateTime',
        'processing_type' => '\VRPayment\Sdk\Model\SubscriptionChargeProcessingType',
        'reference' => 'string',
        'state' => '\VRPayment\Sdk\Model\SubscriptionChargeState',
        'subscription' => '\VRPayment\Sdk\Model\Subscription',
        'succeed_on' => '\DateTime',
        'success_url' => 'string',
        'transaction' => '\VRPayment\Sdk\Model\Transaction',
        'type' => '\VRPayment\Sdk\Model\SubscriptionChargeType',
        'version' => 'int'
    ];
     ...
     * Gets ledger_entries
     *
     * @return \VRPayment\Sdk\Model\SubscriptionLedgerEntry[]
     */
     ...
     * Sets ledger_entries
     *
     * @param \VRPayment\Sdk\Model\SubscriptionLedgerEntry[] $ledger_entries The ledger entries that belong to the charge.
     *
     * @return $this
     */
     ...
     *
     * @return \VRPayment\Sdk\Model\SubscriptionChargeProcessingType
     */
     ...
     *
     * @param \VRPayment\Sdk\Model\SubscriptionChargeProcessingType $processing_type The processing type specifies how the charge is to be processed.
     *
     * @return $this
     */
     ...
     * Gets state
     *
     * @return \VRPayment\Sdk\Model\SubscriptionChargeState
     */
     ...
     * Sets state
     *
     * @param \VRPayment\Sdk\Model\SubscriptionChargeState $state The object's current state.
     *
     * @return $this
     */
     ...
     * Sets subscription
     *
     * @param \VRPayment\Sdk\Model\Subscription $subscription The subscription that the charge belongs to.
     *
     * @return $this
     */
     ...
     * Sets transaction
     *
     * @param \VRPayment\Sdk\Model\Transaction $transaction The transaction used to process the charge.
     *
     * @return $this
     */
     ...
     * Gets type
     *
     * @return \VRPayment\Sdk\Model\SubscriptionChargeType
     */
     ...
     * Sets type
     *
     * @param \VRPayment\Sdk\Model\SubscriptionChargeType $type The type specified how the charge was initiated.
     *
     * @return $this
     */
