...
class WebhookListener implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'id' => 'int',
        'identity' => '\VRPayment\Sdk\Model\WebhookIdentity',
        'linked_space_id' => 'int',
        'name' => 'string',
        'notify_every_change' => 'bool',
        'planned_purge_date' => '\DateTime',
        'state' => '\VRPayment\Sdk\Model\CreationEntityState',
        'url' => '\VRPayment\Sdk\Model\WebhookUrl',
        'version' => 'int'
    ];
     ...
     * Gets identity
     *
     * @return \VRPayment\Sdk\Model\WebhookIdentity
     */
     ...
     * Sets identity
     *
     * @param \VRPayment\Sdk\Model\WebhookIdentity $identity The identity used to sign messages.
     *
     * @return $this
     */
     ...
     * Sets url
     *
     * @param \VRPayment\Sdk\Model\WebhookUrl $url The URL where notifications about entity changes are sent to.
     *
     * @return $this
     */
