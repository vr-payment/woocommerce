...
class ManualTask implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'state' => '\VRPayment\Sdk\Model\ManualTaskState',
        'type' => 'int'
    ];
     ...
     * Gets state
     *
     * @return \VRPayment\Sdk\Model\ManualTaskState
     */
     ...
     * Sets state
     *
     * @param \VRPayment\Sdk\Model\ManualTaskState $state The object's current state.
     *
     * @return $this
     */
