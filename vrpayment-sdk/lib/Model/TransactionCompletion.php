...
class TransactionCompletion implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'line_item_version' => '\VRPayment\Sdk\Model\TransactionLineItemVersion',
        'line_items' => '\VRPayment\Sdk\Model\LineItem[]',
        'linked_space_id' => 'int',
        'linked_transaction' => 'int',
        'mode' => '\VRPayment\Sdk\Model\TransactionCompletionMode',
        'next_update_on' => '\DateTime',
        'payment_information' => 'string',
        'planned_purge_date' => '\DateTime',
        'processing_on' => '\DateTime',
        'processor_reference' => 'string',
        'remaining_line_items' => '\VRPayment\Sdk\Model\LineItem[]',
        'space_view_id' => 'int',
        'state' => '\VRPayment\Sdk\Model\TransactionCompletionState',
     ...
     *
     * @param \VRPayment\Sdk\Model\LineItem[] $base_line_items The original line items from the transaction that serve as the baseline for this completion.
     *
     * @return $this
     */
     ...
     * Sets failure_reason
     *
     * @param \VRPayment\Sdk\Model\FailureReason $failure_reason The reason for the failure of the transaction completion.
     *
     * @return $this
     */
     ...
     *
     * @param \VRPayment\Sdk\Model\TransactionLineItemVersion $line_item_version The specific version of the line items that are being used for this completion.
     *
     * @return $this
     */
     ...
     * Sets line_items
     *
     * @param \VRPayment\Sdk\Model\LineItem[] $line_items The line items captured in this transaction completion.
     *
     * @return $this
     */
     ...
     * Gets mode
     *
     * @return \VRPayment\Sdk\Model\TransactionCompletionMode
     */
     ...
     * Sets mode
     *
     * @param \VRPayment\Sdk\Model\TransactionCompletionMode $mode The mode of transaction completion, such as online or offline, determining how the completion process is executed.
     *
     * @return $this
     */
     ...
     *
     * @param \VRPayment\Sdk\Model\LineItem[] $remaining_line_items The line items yet to be captured in the transaction.
     *
     * @return $this
     */
     ...
     * Gets state
     *
     * @return \VRPayment\Sdk\Model\TransactionCompletionState
     */
     ...
     * Sets state
     *
     * @param \VRPayment\Sdk\Model\TransactionCompletionState $state The object's current state.
     *
     * @return $this
     */
