...
class PaymentMethodConfiguration implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param \VRPayment\Sdk\Model\ModelResourcePath $image_resource_path The resource path to a custom image for the payment method, displayed to the customer for visual identification.
     *
     * @return $this
     */
