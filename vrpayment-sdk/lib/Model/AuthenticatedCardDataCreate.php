...
class AuthenticatedCardDataCreate implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param \VRPayment\Sdk\Model\CardholderAuthenticationCreate $cardholder_authentication The cardholder authentication information. The authentication is optional and can be provided if the cardholder has been already authenticated (e.g. in 3-D Secure system).
     *
     * @return $this
     */
     ...
     * Sets cryptogram
     *
     * @param \VRPayment\Sdk\Model\CardCryptogramCreate $cryptogram The additional authentication value used to secure the tokenized card transactions.
     *
     * @return $this
     */
     ...
     * Sets pan_type
     *
     * @param \VRPayment\Sdk\Model\PanType $pan_type 
     *
     * @return $this
     */
     ...
     *
     * @param \VRPayment\Sdk\Model\RecurringIndicator $recurring_indicator 
     *
     * @return $this
     */
