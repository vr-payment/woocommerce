...
class AuthenticatedCardDataCreate implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'cardholder_authentication' => '\VRPayment\Sdk\Model\CardholderAuthenticationCreate',
        'cryptogram' => '\VRPayment\Sdk\Model\CardCryptogramCreate',
        'expiry_date' => 'string',
        'pan_type' => '\VRPayment\Sdk\Model\PanType',
        'primary_account_number' => 'string',
        'recurring_indicator' => '\VRPayment\Sdk\Model\RecurringIndicator',
     ...
     *
     * @return \VRPayment\Sdk\Model\CardholderAuthenticationCreate
     */
     ...
     *
     * @param \VRPayment\Sdk\Model\CardholderAuthenticationCreate $cardholder_authentication Optional authentication details for the cardholder, such as 3D Secure authentication, used when the cardholder has already been verified during the transaction for added security.
     *
     * @return $this
     */
     ...
     * Gets cryptogram
     *
     * @return \VRPayment\Sdk\Model\CardCryptogramCreate
     */
     ...
     * Sets cryptogram
     *
     * @param \VRPayment\Sdk\Model\CardCryptogramCreate $cryptogram An additional authentication value that enhances the security of tokenized card transactions.
     *
     * @return $this
     */
     ...
     * Gets pan_type
     *
     * @return \VRPayment\Sdk\Model\PanType
     */
     ...
     * Sets pan_type
     *
     * @param \VRPayment\Sdk\Model\PanType $pan_type The type of PAN or token, indicating the source or security method of the card information.
     *
     * @return $this
     */
     ...
     *
     * @return \VRPayment\Sdk\Model\RecurringIndicator
     */
     ...
     *
     * @param \VRPayment\Sdk\Model\RecurringIndicator $recurring_indicator The indicator used to distinguish between recurring and one-time transactions. If omitted, it will be automatically determined based on the transaction's properties.
     *
     * @return $this
     */
