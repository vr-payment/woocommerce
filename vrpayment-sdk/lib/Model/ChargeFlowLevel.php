...
class ChargeFlowLevel implements ModelInterface, ArrayAccess
{
     ...
     * Sets configuration
     *
     * @param \VRPayment\Sdk\Model\ChargeFlowLevelConfiguration $configuration The configuration that was used for this charge flow level.
     *
     * @return $this
     */
     ...
     * Sets transaction
     *
     * @param \VRPayment\Sdk\Model\Transaction $transaction The transaction that the charge flow level belongs to.
     *
     * @return $this
     */
