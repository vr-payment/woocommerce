...
class PaymentLink implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param \VRPayment\Sdk\Model\PaymentMethodConfiguration[] $allowed_payment_method_configurations The payment method configurations that customers can use for making payments.
     *
     * @return $this
     */
     ...
     *
     * @param \VRPayment\Sdk\Model\PaymentLinkAddressHandlingMode $billing_address_handling_mode The handling mode defines whether a billing address is required and specifies how it should be provided.
     *
     * @return $this
     */
     ...
     * Sets line_items
     *
     * @param \VRPayment\Sdk\Model\LineItem[] $line_items The line items representing what is being sold. If not specified, they can be supplied via request parameters.
     *
     * @return $this
     */
     ...
     *
     * @param \VRPayment\Sdk\Model\PaymentLinkAddressHandlingMode $shipping_address_handling_mode The handling mode defines whether a shipping address is required and specifies how it should be provided.
     *
     * @return $this
     */
