...
class PaymentLink implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'allowed_payment_method_configurations' => '\VRPayment\Sdk\Model\PaymentMethodConfiguration[]',
        'applied_space_view' => 'int',
        'available_from' => '\DateTime',
        'available_until' => '\DateTime',
        'billing_address_handling_mode' => '\VRPayment\Sdk\Model\PaymentLinkAddressHandlingMode',
        'currency' => 'string',
        'external_id' => 'string',
        'id' => 'int',
        'language' => 'string',
        ...
        'protection_mode' => '\VRPayment\Sdk\Model\PaymentLinkProtectionMode',
        'shipping_address_handling_mode' => '\VRPayment\Sdk\Model\PaymentLinkAddressHandlingMode',
     ...
     *
     * @param \VRPayment\Sdk\Model\PaymentMethodConfiguration[] $allowed_payment_method_configurations The allowed payment method configurations restrict the payment methods which can be used with this payment link.
     *
     * @return $this
     */
     ...
     *
     * @return \VRPayment\Sdk\Model\PaymentLinkAddressHandlingMode
     */
     ...
     *
     * @param \VRPayment\Sdk\Model\PaymentLinkAddressHandlingMode $billing_address_handling_mode The billing address handling mode controls if the address is collected or not and how it is collected.
     *
     * @return $this
     */
     ...
     * Sets line_items
     *
     * @param \VRPayment\Sdk\Model\LineItem[] $line_items The line items allows to define the line items for this payment link. When the line items are defined they cannot be overridden through the request parameters. If no amount for the payment link is defined, the additional checkout page to enter the amount is shown to the consumer.
     *
     * @return $this
     */
     ...
     *
     * @return \VRPayment\Sdk\Model\PaymentLinkProtectionMode
     */
     ...
     *
     * @param \VRPayment\Sdk\Model\PaymentLinkAddressHandlingMode $shipping_address_handling_mode The shipping address handling mode controls if the address is collected or not and how it is collected.
     *
     * @return $this
     */
