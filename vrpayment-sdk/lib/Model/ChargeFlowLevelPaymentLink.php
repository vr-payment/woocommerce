...
class ChargeFlowLevelPaymentLink implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'charge_flow_level' => '\VRPayment\Sdk\Model\ChargeFlowLevel',
        'id' => 'int',
        'linked_space_id' => 'int',
        'payment_link' => 'string'
    ];
     ...
     *
     * @param \VRPayment\Sdk\Model\ChargeFlowLevel $charge_flow_level The charge flow level that the payment link belongs to.
     *
     * @return $this
     */
