...
class Subscription implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'affiliate' => '\VRPayment\Sdk\Model\SubscriptionAffiliate',
        'created_on' => '\DateTime',
        'current_product_version' => '\VRPayment\Sdk\Model\SubscriptionProductVersion',
        'description' => 'string',
        'id' => 'int',
        ...
        'reference' => 'string',
        'state' => '\VRPayment\Sdk\Model\SubscriptionState',
        'subscriber' => '\VRPayment\Sdk\Model\Subscriber',
        'terminated_by' => 'int',
     ...
     * Gets affiliate
     *
     * @return \VRPayment\Sdk\Model\SubscriptionAffiliate
     */
     ...
     * Sets affiliate
     *
     * @param \VRPayment\Sdk\Model\SubscriptionAffiliate $affiliate The affiliate that led to the creation of the subscription.
     *
     * @return $this
     */
     ...
     *
     * @param \VRPayment\Sdk\Model\SubscriptionProductVersion $current_product_version The version of the product that the subscription is currently linked to.
     *
     * @return $this
     */
     ...
     * Gets state
     *
     * @return \VRPayment\Sdk\Model\SubscriptionState
     */
     ...
     * Sets state
     *
     * @param \VRPayment\Sdk\Model\SubscriptionState $state The object's current state.
     *
     * @return $this
     */
     ...
     * Gets subscriber
     *
     * @return \VRPayment\Sdk\Model\Subscriber
     */
     ...
     * Sets subscriber
     *
     * @param \VRPayment\Sdk\Model\Subscriber $subscriber The subscriber that the subscription belongs to.
     *
     * @return $this
     */
     ...
     * Sets token
     *
     * @param \VRPayment\Sdk\Model\Token $token The payment token that is used to charge the customer.
     *
     * @return $this
     */
