...
class PaymentAppConnector implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'completion_configuration' => '\VRPayment\Sdk\Model\PaymentAppCompletionConfiguration',
        ...
        'processor' => '\VRPayment\Sdk\Model\PaymentAppProcessor',
        'refund_configuration' => '\VRPayment\Sdk\Model\PaymentAppRefundConfiguration',
        'state' => '\VRPayment\Sdk\Model\PaymentAppConnectorState',
        'updated_on' => '\DateTime',
        'version' => 'int'
    ];
     ...
     *
     * @return \VRPayment\Sdk\Model\PaymentAppCompletionConfiguration
     */
     ...
     *
     * @param \VRPayment\Sdk\Model\PaymentAppCompletionConfiguration $completion_configuration The completion configuration defines how the deferred completion is processed. If it is not present it means that deferred completion is not supported by this connector.
     *
     * @return $this
     */
     ...
     *
     * @param \VRPayment\Sdk\Model\PaymentConnectorConfiguration $connector_configuration The connector configuration references the configuration that was created as part of this connector within the space. The connector configuration is referenced within transactions created with this connector.
     *
     * @return $this
     */
     ...
     * Sets processor
     *
     * @param \VRPayment\Sdk\Model\PaymentAppProcessor $processor The processor references the app processor to which this connector belongs to. The relationship is established during the creation of the connector.
     *
     * @return $this
     */
     ...
     *
     * @return \VRPayment\Sdk\Model\PaymentAppRefundConfiguration
     */
     ...
     *
     * @param \VRPayment\Sdk\Model\PaymentAppRefundConfiguration $refund_configuration The refund configuration defines how refunds are processed. If it is not present it means that refunds are not supported by this connector.
     *
     * @return $this
     */
     ...
     * Gets state
     *
     * @return \VRPayment\Sdk\Model\PaymentAppConnectorState
     */
     ...
     * Sets state
     *
     * @param \VRPayment\Sdk\Model\PaymentAppConnectorState $state The object's current state.
     *
     * @return $this
     */
