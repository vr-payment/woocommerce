...
class SubscriptionPeriodBill implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'state' => '\VRPayment\Sdk\Model\SubscriptionPeriodBillState',
        'subscription_version' => '\VRPayment\Sdk\Model\SubscriptionVersion',
        'version' => 'int'
    ];
     ...
     * Gets state
     *
     * @return \VRPayment\Sdk\Model\SubscriptionPeriodBillState
     */
     ...
     * Sets state
     *
     * @param \VRPayment\Sdk\Model\SubscriptionPeriodBillState $state The object's current state.
     *
     * @return $this
     */
     ...
     *
     * @param \VRPayment\Sdk\Model\SubscriptionVersion $subscription_version The subscription version that the period bill belongs to.
     *
     * @return $this
     */
