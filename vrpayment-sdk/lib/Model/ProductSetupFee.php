...
class ProductSetupFee implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'component' => '\VRPayment\Sdk\Model\SubscriptionProductComponent',
        'description' => 'map[string,string]',
        'id' => 'int',
        'linked_space_id' => 'int',
        'name' => 'map[string,string]',
        'on_downgrade_credited_amount' => '\VRPayment\Sdk\Model\PersistableCurrencyAmount[]',
        'on_upgrade_credited_amount' => '\VRPayment\Sdk\Model\PersistableCurrencyAmount[]',
        'setup_fee' => '\VRPayment\Sdk\Model\PersistableCurrencyAmount[]',
        'type' => '\VRPayment\Sdk\Model\ProductFeeType',
        'version' => 'int'
    ];
     ...
     * Sets component
     *
     * @param \VRPayment\Sdk\Model\SubscriptionProductComponent $component The product component that the fee belongs to.
     *
     * @return $this
     */
     ...
     *
     * @return \VRPayment\Sdk\Model\PersistableCurrencyAmount[]
     */
     ...
     *
     * @param \VRPayment\Sdk\Model\PersistableCurrencyAmount[] $on_downgrade_credited_amount The amount charged to the customer when a subscription is downgraded.
     *
     * @return $this
     */
     ...
     *
     * @param \VRPayment\Sdk\Model\PersistableCurrencyAmount[] $on_upgrade_credited_amount The amount charged to the customer when a subscription is upgraded.
     *
     * @return $this
     */
     ...
     * Sets setup_fee
     *
     * @param \VRPayment\Sdk\Model\PersistableCurrencyAmount[] $setup_fee The amount charged to the customer once when they subscribe to a subscription.
     *
     * @return $this
     */
     ...
     * Gets type
     *
     * @return \VRPayment\Sdk\Model\ProductFeeType
     */
     ...
     * Sets type
     *
     * @param \VRPayment\Sdk\Model\ProductFeeType $type The type of the fee.
     *
     * @return $this
     */
