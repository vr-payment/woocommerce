...
class PaymentAppConnectorCreationRequest implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'completion_configuration' => '\VRPayment\Sdk\Model\PaymentAppCompletionConfigurationCreate',
        'connector' => 'int',
        'external_id' => 'string',
        'name' => 'string',
        'payment_page_endpoint' => 'string',
        'processor_external_id' => 'string',
        'refund_configuration' => '\VRPayment\Sdk\Model\PaymentAppRefundConfigurationCreate'
    ];
     ...
     *
     * @return \VRPayment\Sdk\Model\PaymentAppCompletionConfigurationCreate
     */
     ...
     *
     * @param \VRPayment\Sdk\Model\PaymentAppCompletionConfigurationCreate $completion_configuration The completion configuration allows the connector to support deferred completions on a transaction. If it is not provided the connector will not process transactions in deferred mode.
     *
     * @return $this
     */
     ...
     *
     * @return \VRPayment\Sdk\Model\PaymentAppRefundConfigurationCreate
     */
     ...
     *
     * @param \VRPayment\Sdk\Model\PaymentAppRefundConfigurationCreate $refund_configuration The refund configuration allows the connector to support refunds on transactions. In case no refund configuration is provided the connector will not support refunds.
     *
     * @return $this
     */
