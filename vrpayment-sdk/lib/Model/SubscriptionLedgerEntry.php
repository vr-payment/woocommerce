...
class SubscriptionLedgerEntry implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'external_id' => 'string',
        'fee_type' => '\VRPayment\Sdk\Model\ProductFeeType',
        'id' => 'int',
        'linked_space_id' => 'int',
        'planned_purge_date' => '\DateTime',
        'pro_rata_calculated' => 'bool',
        'quantity' => 'float',
        'state' => '\VRPayment\Sdk\Model\SubscriptionLedgerEntryState',
     ...
     * Sets fee_type
     *
     * @param \VRPayment\Sdk\Model\ProductFeeType $fee_type 
     *
     * @return $this
     */
     ...
     * Gets state
     *
     * @return \VRPayment\Sdk\Model\SubscriptionLedgerEntryState
     */
     ...
     * Sets state
     *
     * @param \VRPayment\Sdk\Model\SubscriptionLedgerEntryState $state The object's current state.
     *
     * @return $this
     */
     ...
     * Sets taxes
     *
     * @param \VRPayment\Sdk\Model\Tax[] $taxes A set of tax lines, each of which specifies a tax applied to the ledger entry.
     *
     * @return $this
     */
