...
class PaymentAppProcessor implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'configured_environment' => '\VRPayment\Sdk\Model\ChargeAttemptEnvironment',
        'created_on' => '\DateTime',
        ...
        'state' => '\VRPayment\Sdk\Model\PaymentAppProcessorState',
        'svg_icon' => 'string',
        'updated_on' => '\DateTime',
     ...
     *
     * @param \VRPayment\Sdk\Model\ChargeAttemptEnvironment $configured_environment The environment (e.g., test or production) currently configured for the processor.
     *
     * @return $this
     */
     ...
     *
     * @param \VRPayment\Sdk\Model\PaymentProcessorConfiguration $processor_configuration The processor configuration created alongside the process within its designated space. This configuration is used in transactions created using this processor.
     *
     * @return $this
     */
     ...
     * Gets state
     *
     * @return \VRPayment\Sdk\Model\PaymentAppProcessorState
     */
     ...
     * Sets state
     *
     * @param \VRPayment\Sdk\Model\PaymentAppProcessorState $state The object's current state.
     *
     * @return $this
     */
