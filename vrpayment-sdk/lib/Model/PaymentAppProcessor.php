...
class PaymentAppProcessor implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param \VRPayment\Sdk\Model\ChargeAttemptEnvironment $configured_environment 
     *
     * @return $this
     */
     ...
     *
     * @param \VRPayment\Sdk\Model\PaymentProcessorConfiguration $processor_configuration This processor configuration is created as part of the app processor. Any transaction created with the processor is linked with this processor configuration.
     *
     * @return $this
     */
