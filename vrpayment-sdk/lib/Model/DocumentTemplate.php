...
class DocumentTemplate implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'template_resource' => '\VRPayment\Sdk\Model\ModelResourcePath',
        'type' => 'int',
        'version' => 'int'
    ];
     ...
     *
     * @param \VRPayment\Sdk\Model\ModelResourcePath $template_resource The resource path to a custom template to be used to generate PDF documents.
     *
     * @return $this
     */
