...
class BankTransaction implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'adjustments' => '\VRPayment\Sdk\Model\PaymentAdjustment[]',
        'created_by' => 'int',
        'created_on' => '\DateTime',
        'currency_bank_account' => '\VRPayment\Sdk\Model\CurrencyBankAccount',
        'external_id' => 'string',
        'flow_direction' => '\VRPayment\Sdk\Model\BankTransactionFlowDirection',
        'id' => 'int',
        'linked_space_id' => 'int',
        ...
        'reference' => 'string',
        'source' => 'int',
        'state' => '\VRPayment\Sdk\Model\BankTransactionState',
     ...
     * Gets adjustments
     *
     * @return \VRPayment\Sdk\Model\PaymentAdjustment[]
     */
     ...
     * Sets adjustments
     *
     * @param \VRPayment\Sdk\Model\PaymentAdjustment[] $adjustments Adjustments are changes made to the initial transaction amount, such as fees or corrections.
     *
     * @return $this
     */
     ...
     *
     * @return \VRPayment\Sdk\Model\CurrencyBankAccount
     */
     ...
     *
     * @param \VRPayment\Sdk\Model\CurrencyBankAccount $currency_bank_account The currency bank account that sends or receives money based on the bank transaction's flow direction.
     *
     * @return $this
     */
     ...
     * Gets flow_direction
     *
     * @return \VRPayment\Sdk\Model\BankTransactionFlowDirection
     */
     ...
     * Sets flow_direction
     *
     * @param \VRPayment\Sdk\Model\BankTransactionFlowDirection $flow_direction Indicates the direction of a bank transaction, specifying whether the amount flows into or out of the bank account.
     *
     * @return $this
     */
     ...
     * Gets state
     *
     * @return \VRPayment\Sdk\Model\BankTransactionState
     */
     ...
     * Sets state
     *
     * @param \VRPayment\Sdk\Model\BankTransactionState $state The object's current state.
     *
     * @return $this
     */
