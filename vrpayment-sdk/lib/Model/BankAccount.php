...
class BankAccount implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'state' => '\VRPayment\Sdk\Model\BankAccountState',
        'type' => 'int',
        'version' => 'int'
    ];
     ...
     * Gets state
     *
     * @return \VRPayment\Sdk\Model\BankAccountState
     */
     ...
     * Sets state
     *
     * @param \VRPayment\Sdk\Model\BankAccountState $state The object's current state.
     *
     * @return $this
     */
