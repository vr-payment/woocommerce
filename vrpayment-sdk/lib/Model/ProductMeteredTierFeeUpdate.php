...
class ProductMeteredTierFeeUpdate implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'id' => 'int',
        'version' => 'int',
        'fee' => '\VRPayment\Sdk\Model\PersistableCurrencyAmountUpdate[]',
        'metered_fee' => 'int',
        'start_range' => 'float'
    ];
     ...
     * Sets fee
     *
     * @param \VRPayment\Sdk\Model\PersistableCurrencyAmountUpdate[] $fee The amount charged to the customer for each consumed unit at the end of a billing cycle.
     *
     * @return $this
     */
