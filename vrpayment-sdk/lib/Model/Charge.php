...
class Charge implements ModelInterface, ArrayAccess
{
     ...
     * Sets failure_reason
     *
     * @param \VRPayment\Sdk\Model\FailureReason $failure_reason The reason for the failure of the charge.
     *
     * @return $this
     */
     ...
     * Sets transaction
     *
     * @param \VRPayment\Sdk\Model\Transaction $transaction The transaction that the charge belongs to.
     *
     * @return $this
     */
     ...
     * Sets type
     *
     * @param \VRPayment\Sdk\Model\ChargeType $type The type specifying how the customer was charged.
     *
     * @return $this
     */
