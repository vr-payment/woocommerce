...
class PaymentAppCompletionUpdateRequest implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'reference' => 'string',
        'target_state' => '\VRPayment\Sdk\Model\PaymentAppCompletionTargetState'
    ];
     ...
     * Gets target_state
     *
     * @return \VRPayment\Sdk\Model\PaymentAppCompletionTargetState
     */
     ...
     * Sets target_state
     *
     * @param \VRPayment\Sdk\Model\PaymentAppCompletionTargetState $target_state The target state defines the state into which the completion should be switched into. Once the completion changed the state it will not be possible to change it again.
     *
     * @return $this
     */
