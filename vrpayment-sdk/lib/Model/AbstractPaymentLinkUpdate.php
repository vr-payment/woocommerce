...
class AbstractPaymentLinkUpdate implements ModelInterface, ArrayAccess
{
     ...
     * Sets line_items
     *
     * @param \VRPayment\Sdk\Model\LineItemCreate[] $line_items The line items representing what is being sold. If not specified, they can be supplied via request parameters.
     *
     * @return $this
     */
