...
class RefundRecoveryBankTransaction implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'bank_transaction' => '\VRPayment\Sdk\Model\BankTransaction',
        'id' => 'int',
        'language' => 'string',
        'line_items' => '\VRPayment\Sdk\Model\LineItem[]',
        'linked_space_id' => 'int',
        'linked_transaction' => 'int',
        'refund' => '\VRPayment\Sdk\Model\Refund',
     ...
     * Sets line_items
     *
     * @param \VRPayment\Sdk\Model\LineItem[] $line_items The line items that were recovered.
     *
     * @return $this
     */
     ...
     * Sets refund
     *
     * @param \VRPayment\Sdk\Model\Refund $refund The refund this bank transaction belongs to.
     *
     * @return $this
     */
