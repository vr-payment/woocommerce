...
final class ApiClientTest extends TestCase
{
    ...
    {
        putenv('VRP_HTTP_CLIENT=' . HttpClientFactory::TYPE_CURL);
        $this->assertEquals(HttpClientFactory::getClient(HttpClientFactory::TYPE_CURL), HttpClientFactory::getClient());
        
        putenv('VRP_HTTP_CLIENT=' . HttpClientFactory::TYPE_SOCKET);
    ...
    public function testSdkHeaders()
    {
        ...
        $this->assertEquals($headers['x-meta-sdk-version'], "4.9.1");
